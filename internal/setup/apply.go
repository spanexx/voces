...
// $XDG_CONFIG_HOME/whisper-voice-util. Falls back to the XDG default
// (UserConfigDir) when XDG_CONFIG_HOME is unset.
func configPath() (string, error) {
	if v := os.Getenv("XDG_CONFIG_HOME"); v != "" {
		return filepath.Join(v, "whisper-voice-util", "config.yaml"), nil
	}
	return filepath.Join(os.Getenv("HOME"), ".config", "whisper-voice-util", "config.yaml"), nil
}
...
func buildConfigDoc(s *State, cfgPath string) ([]byte, error) {
	...
	return append([]byte("# Whisper Voice Utility — generated by setup wizard\n"), out...), nil
}
